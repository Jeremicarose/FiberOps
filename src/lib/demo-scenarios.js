...
export const demoScenarios = [
  {
    ...
    description: "A payment fails because Fiber cannot build a viable route with the current graph and balances.",
    request: {
      amount: "150000000",
      targetPubkey: "0x0293a7b4b4c1dbba2fca5f2cf7ce6d85afdfbb31f872f2f91b6720e2a4bb6a9011"
    },
    context: {
      nodeInfo: {
        version: "v0.9.0-rc5",
  ...
  },
  {
    ...
    description: "The route exists, but the relay fees exceed the sender's max fee budget.",
    request: {
      amount: "95000000"
    },
    context: {
  ...
  },
  {
    ...
    description: "The invoice is valid structurally, but its expiry has already passed.",
    request: {
      amount: "25000000",
    ...
    context: {
      ...
      parsedInvoice: {
        ...
        timestamp: now - 7200,
        expiry: 3600,
        payment_hash: "0x8d9dbb9d9328f93ccfd4d469ef29b97f6f18b65297d6f7df2d1198495d2f1c11",
        data: {
          attrs: [
            {
  ...
  },
  {
    ...
    description: "A trampoline payment fails because the selected trampoline node does not support the required feature bit.",
    request: {
      amount: "42000000"
    },
    context: {
  ...
  },
  {
    ...
    description: "The sender has capacity, but the destination pubkey is not visible in the current graph snapshot.",
    request: {
      amount: "25000000",
  ...
  },
  {
    ...
    description: "The node has an open channel, but outbound liquidity is too low for the requested amount before a send is attempted.",
    request: {
      amount: "350000000"
    },
    context: {
  ...
  },
  {
    ...
    description: "The node returns channels, but none are in an open or ready state for payment forwarding.",
    request: {
      amount: "25000000"
    },
    context: {
  ...
  },
  {
    ...
    description: "The node responds, but the caller is missing a valid Biscuit bearer token.",
    request: {
  ...
  },
  {
    ...
    description: "The node cannot be reached over JSON-RPC, which blocks diagnostics entirely.",
    request: {
      endpoint: "http://127.0.0.1:8227"
    },
    context: {
